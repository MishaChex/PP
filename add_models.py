from models import pharmacy, users, medicine,create_engine
...
user1 = users(id=1, name='Nazar', phone='+380675617204', mail='lol@gmail.com', password='1111')
user2 = users(id=2, name='Vova', phone='+380500666028', mail='kek@gmail.com', password='2222')
